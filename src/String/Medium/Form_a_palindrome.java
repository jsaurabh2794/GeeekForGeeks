...
public class Form_a_palindrome {
    ...
    public static void main(String[] args) {
        ...
        while (testCase-- > 0) {
            ...
            int minimumNoChar = formAPalindrome(str);
            System.out.println(minimumNoChar);
        }
    }

    private static int formAPalindrome(String str) {
        if (str.equals(new StringBuilder(str).reverse().toString())) {
            return 0;
        }
        int longestPalindromeSubSequence = getLongestPalindromeSubSequence(str);
        return str.length() - longestPalindromeSubSequence;
    }

    private static int getLongestPalindromeSubSequence(String str) {
